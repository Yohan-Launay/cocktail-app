...
export const List: FunctionComponent<Props> = ({ cocktails }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">Cocktail List</h1>
      <Link
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {cocktails &&
          ...
          cocktails.map(
            (cocktail) =>
              cocktail["@id"] && (
                <tr className="py-2" key={cocktail["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(cocktail["@id"], "/cocktails/[id]"),
                        name: cocktail["@id"],
                      }}
                    />
                  </th>
